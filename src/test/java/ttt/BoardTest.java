...
public class BoardTest {
    ...
    @Test
    public void availaibleLocations() {
    ...
    @Test
    public void createsDummyBoardwithLocations() {
        board.placeMark("X", 0);
        assertEquals(Arrays.asList(1, 2, 3, 4, 5, 6, 7, 8), board.dummyBoard().availableMoves());
    }

    @Test
    public void changesToDummyDoNotAffectBoard() {
        Board dummy = board.dummyBoard();
        dummy.placeMark("X", 0);
        assertEquals(" ", board.get(0));
    }
    ...
    public void knowsWinnerForHorizontalWin() {
        horizontalWin();
        assertTrue(board.winFor("X"));
    }

    @Test
    public void knowsWinnerForDiagonalWin() {
        diagonalWin();
        assertTrue(board.winFor("O"));
    }
